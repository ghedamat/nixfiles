#!/usr/bin/env sh
# https://github.com/shazow/nixfiles/commit/99ed2b26184387cc2c0adc8dc2edfa3c1197557b
...
scratch_alacritty() {
    ...
    if ! xdotool search --classname "$class"; then
        alacritty --class "$class" -o background_opacity=0.8 -e tmux new-session -A -s scratch &
        sleep 0.2
    fi
